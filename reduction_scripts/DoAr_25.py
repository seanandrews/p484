...
fitspw = '0:0~1880;1960~3839, 1:0~1880;1960~3839, 2:0~1880; 1960~3839' # channels for fitting continuum
...
mstransform(vis = SB1_CO_mscontsub, outputvis = CO_cvel,  keepflags = False,datacolumn = 'data', regridms = True,mode='velocity',start='-7km/s',width='0.35km/s',nchan=70, outframe='LSRK', veltype='radio', restfreq='230.53800GHz')
