...
Note: if you do everything in this script, you'll use up about 305 GB of space.
The final calibrated continuum MS is 5.9 GB.
...
LB_data = '/data/sandrews/LP/2016.1.00484.L/science_goal.uid___A001_X8c5_X64/group.uid___A001_X8c5_X65/member.uid___A001_X8c5_X66/calibrated/calibrated_final.ms'
SB_refant = 'DA59, DV18, DV15'
all_refant = 'DA61'
SB_contspws = '0~11'
LB_contspws = '0~7'
all_contspws = '0~19'
SB_mask = 'circle[[254pix,236pix],0.8arcsec]'
all_mask = 'ellipse[[1540pix, 1355pix], [0.7arcsec,0.5arcsec], 140deg]'
...
flagchannels = '0:1700~2200, 4:1700~2200, 8:1700~2200'
...
peak = 36.9 mJy/beam, flux = 65.7 mJy, rms = 79 uJy/beam, beam = 0.26 x 0.22"
peak SNR = 467
...
peak = 39.2 mJy/beam, flux = 66.2 mJy, rms = 41 uJy/beam, beam = 0.26 x 0.22"
peak SNR = 956
...
"""
cleaned for 5 cycles (500 iterations)
peak = 40.0 mJy/beam, flux = 66.2 mJy, rms = 39 uJy/beam, beam = 0.26 x 0.22"
peak SNR = 1026
...
"""
cleaned for 5 cycles (500 iterations)
peak = 40.1 mJy/beam, flux = 66.3 mJy, rms = 34 uJy/beam, beam = 0.26 x 0.22"
peak SNR = 1179
...
flagchannels = '3:1800~2000, 6:101~127, 7:1800~2000'
...
plotms(vis=LB_initcont, xaxis='uvdist', yaxis='amp', coloraxis='observation',
       avgtime='30', avgchannel='1000')
### the overlap between the EBs is reasonable.

# initial imaging for LB execution block 0 = LB0, 2017/09/10 (C40-8)
...
peak = 5.9 mJy/beam, flux = 63 mJy, rms = 23 uJy/beam, beam = 81 x 41 mas
peak SNR = 257

"""

# initial imaging for LB execution block 1 = LB1, 2017/10/07 (C43-10)
...
"""
cleaned for 3 cycles (300 iterations)
peak = 2.4 mJy/beam, flux = 69.2 mJy, rms = 22 uJy/beam, beam = 30 x 26 mas
peak SNR = 109
...
pc_SB  = au.radec2deg('16:27:39.430000, -24.39.15.54000')
pc_LB0 = au.radec2deg('16:27:39.430000, -24.39.15.54000')
pc_LB1 = au.radec2deg('16:27:39.430000, -24.39.15.54000')
# disk centroids (from imfit):
peak_SB  = au.radec2deg('16:27:39.42136, -24.39.15.96954')
peak_LB0 = au.radec2deg('16:27:39.42150, -24.39.15.97652')
peak_LB1 = au.radec2deg('16:27:39.42124, -24.39.15.97470')
...
# (offx, offy) = (-0.13, -0.43)"	[i.e., to the SW]
# Can also make crude estimate of viewing geometry from Gaussian fits:
# deconvolved minor/major axis ratio = 147 / 253 = 0.581, so i = 54.5 degrees.  
# The deconvolved PA = 139 degrees.
...
but that LB0 is low by about 10% compared to both SB and LB1.  However, we do 
not a priori know which calibration is "right".  
...
For the flux (amplitude) calibration, the pipeline used:
	...
	LB0:  J1733-1304, mean Fnu = 1.56 Jy @ 238.7 GHz
	LB1:  J1733-1304, mean Fnu = 1.87 Jy @ 238.7 GHz
...
Updated queries (see below) find:
	...
	LB1:  J1427-4206, Fnu = 1.86 +/- 0.16 Jy
...
au.getALMAFlux('J1733-1304', 238.7, date='2017/09/10')
au.getALMAFlux('J1733-1304', 238.7, date='2017/10/06')

So, this suggests that the SB and LB1 calibrations are actually pretty much 
fine.  The LB0 calibration is in error, but in the wrong direction.  The 
needed rescaling is quite obvious, though, so we will make a manual adjustment.

We will manually scale the LB0 flux calibration up into alignment.
...
peak: 3.78 mJy/beam, flux: 67.9 mJy, rms: 14.3 uJy/beam, beam = 45 x 35 mas
peak SNR: 106
...
plotcal(caltable=all_p1,xaxis='time',yaxis='phase',
        spw='',iteration='antenna',subplot=221,plotrange=[0,0,-180,180],
        timerange='2017/09/09/00~2017/09/12/00')
plotcal(caltable=all_p1,xaxis='time',yaxis='phase',
        spw='',iteration='antenna',subplot=221,plotrange=[0,0,-180,180],
        timerange='2017/10/05/00~2017/10/08/00')
...
peak: 3.88 mJy/beam, flux: 67.7 mJy, rms: 13.1 uJy/beam, beam = 45 x 35 mas
peak SNR: 296
...
peak: 3.97 mJy/beam, flux: 67.4 mJy, rms: 13.0 uJy/beam, beam = 45 x 35 mas
peak SNR: 305
...
peak: 3.71 mJy/beam, flux: 68.4 mJy, rms: 12.7 uJy/beam, beam = 45 x 35 mas
peak SNR = 292
...
split2(vis='WSB_52_combined_selfcal_final.ms', field='0', spw='0~19', 
...
pc_all   = au.radec2deg('16:27:39.430000, -24.39.15.540000')
peak_all = au.radec2deg('16:27:39.421383, -24.39.15.973163')
