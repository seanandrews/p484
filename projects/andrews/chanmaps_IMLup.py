...
cubefile = '/pool/firebolt0/LPscratch_new/IMLup/IMLup_COmidtaper.image.fits'
...
for i in range(48):
    ...
    # annotations
    if (i == 0):
        ax.annotate('IM Lup', xy=(0.08, 0.83), xycoords='axes fraction',
...
fig.savefig('chanmaps_IMLup.png')
fig.clf()
