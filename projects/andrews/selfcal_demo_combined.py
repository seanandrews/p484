...
# image lists
sim_list = ['combined_contp0', 'combined_contp2', 'combined_contp5', 'combined_contap']
notes = [r'${\rm initial}$'+' '+r'${\rm (+}$'+' '+r'${\rm extended)}$',
         r'${\rm phase}$'+' '+r'${\rm self}$'+'-'+r'${\rm cal}$'+' '+r'${\rm (900,}$'+' '+r'${\rm 360s)}$',
         r'${\rm phase}$'+' '+r'${\rm self}$'+'-'+r'${\rm cal}$'+' '+r'${\rm (180,}$'+' '+r'${\rm 60,}$'+' '+r'${\rm 30s)}$',
...
fig.savefig('selfcal_demo_combined.pdf')
fig.clf()
